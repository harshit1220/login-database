...
function storeData(formData) {
    ...
    cell6.innerHTML = `<button onclick="editData(this)" class="btn btn-primary" style="margin: 5px;"> EDIT </button>
    <button onclick="updateData()" class="btn btn-primary" style="margin: 5px;"> UPDATE </button>
...
function deleteData(btn) {
    ...
    if (confirm("Click OK to delete the entry")) {
